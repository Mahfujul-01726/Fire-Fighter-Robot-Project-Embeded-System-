...
/*
  NOTE ON PIN MAPPINGS:
  The pin definitions below (D1-D4 for motors, D5 for buzzer, D8 for LED) 
  correspond exactly to the code extracted from the 'Smart Car (1).docx' file, 
  which is typically configured for a NodeMCU Motor Shield (L293D).
  
  If your physical robot is wired directly to an external L298N driver module 
  as detailed in SYSTEM_ARCHITECTURE.md, please map your pins accordingly:
  - ENA / ENB -> D5 / D6 (PWM speed control)
  - IN1 / IN2 -> D8 / D7 (Left motor direction)
  - IN3 / IN4 -> D4 / D3 (Right motor direction)
*/
